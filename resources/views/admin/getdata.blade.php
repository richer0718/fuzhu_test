                    ...
                    <div class="modal-body">
                        <table class="table" style="margin-bottom:0px;">
                            ...
                            <tr>
                                <td>账号状态</td>
                                <td>
                                    @if(session('res') -> status_name == '微信二维码') <a href="{{ 'http://img.feisushouyou.com/jietu/'.session('res')->area.'-'.session('res')->number.'.jpg' }}" target="_blank" style="color:red;">扫描微信二维码</a>
