                    ...
                    <div class="modal-body">
                        <table class="table" style="margin-bottom:0px;">
                            ...
                            <tr>
                                <td>账号状态</td>
                                <td>
                                    @if(session('res') -> status_name == '微信二维码') <a href="{{ 'http://feifeifuzhu.com/fuzhu/public/images/'.session('res')->area.$maps[session('res') -> map]['game'].'-'.session('res')->number.'.jpg' }}" target="_blank" style="color:red;">扫描微信二维码</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table" style="margin-bottom:0px;">
                        ...
                        <tr>
                            <td colspan="2">
                                <img src="{{ 'http://feifeifuzhu.com/fuzhu/public/images/'.session('res') -> area.$maps[session('res') -> map]['game'] .'-'.session('res') -> number.'.jpg' }}" style="width:100%;height:80px;"  />
                            </td>
                        </tr>
                        @endif
