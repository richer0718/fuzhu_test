                ...
                @unless(!$res)
                    @foreach($res as $k => $vo)
                        <tr>
                            ...
                            -->
                            <td>
                                @if($vo -> status == '微信二维码') <a href="{{ 'http://feisushouyou.com/fuzhu/public/images/'.$vo->area.'-'.$vo->number.'.jpg' }}" target="_blank" style="color:red;">扫描微信二维码</a>
                                @elseif($vo -> status == '手机验证码' )  <a class="yanzhengma" data="{{ $vo -> id }}" style="color:red;">输入验证码</a> <a href="{{ 'http://feisushouyou.com/fuzhu/public/images/'.$vo->area.'-'.$vo->number.'.jpg' }}" target="_blank" style="color:red;">查看图片</a>
                                @elseif($vo -> status == '正常刷完' ) <a href="{{ 'http://feisushouyou.com/fuzhu/public/images/'.$vo->area.'-'.$vo->number.'-wc.jpg' }}" target="_blank" style="color:red;">正常刷完</a>
                                @elseif($vo -> status == '区不存在' ) <a href="{{ 'http://feisushouyou.com/fuzhu/public/images/'.$vo->area.'-'.$vo->number.'-xq.jpg' }}" target="_blank" style="color:red;">区不存在</a>
                                @else{{$vo -> status}}
                                @endif
                            </td>
                            <td>{{$vo -> device}}</td>
