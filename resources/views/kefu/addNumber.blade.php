                ...
                <div class="col-md-5">
                    <table class="table table-striped table-bordered" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td><input type="text"  placeholder="只能填写数字、字母、半角符号（半角逗号除外）"  class="form-control" name="pass" @if(isset($info) || old('pass') ) value="{{ $info -> pass or old('pass') }}" @endif required  /></td>
                        </tr>
                        <tr>
                            <td>大区：</td>
                            <td>
                        ...
                        <tr>
                            <td>小区：</td>
                            <td><input type="number" placeholder="留空或者填0 表示刷默认大区" class="form-control" name="xiaoqu"    /></td>
                        </tr>
                        <tr>
                            <td>刷图选择：</td>
                            <td>
