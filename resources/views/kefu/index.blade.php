                    ...
                    @foreach($res as $k => $vo)
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($vo -> status == '代练完成' ) <a href="{{ 'http://feifeifuzhu.com/fuzhu/public/images/'.$vo->area.$maps[$vo -> truemap]['game'].'-'.$vo->number.'-wc.jpg' }}" target="_blank" style="color:red;">代练完成</a>
